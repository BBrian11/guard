...
Future maybeCreateUser(User user) async {
  final userRecord = ClientsRecord.collection.doc(user.uid);
  final userExists = await userRecord.get().then((u) => u.exists);
  if (userExists) {
    currentUserDocument = await ClientsRecord.getDocumentOnce(userRecord);
    return;
  }

  final userData = createClientsRecordData(
    email: user.email,
  ...
  currentUserDocument =
      serializers.deserializeWith(ClientsRecord.serializer, userData);
}
